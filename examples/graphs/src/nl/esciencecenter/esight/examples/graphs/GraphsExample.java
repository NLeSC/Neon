...
public class GraphsExample {
    ...
    private final static GraphsSettings settings = GraphsSettings.getInstance();
    ...
    private static GraphsInterfaceWindow examplePanel;
    ...
    private static GraphsGLEventListener exampleGLEventListener;
    ...
    public GraphsExample() {
        // Create the Swing interface elements
        examplePanel = new GraphsInterfaceWindow();

        // Create the custom GLEventListener
        exampleGLEventListener = new GraphsGLEventListener();

        // Create the default ESight OpenGL window.
        new ESightNewtWindow(true, GraphsInputHandler.getInstance(), exampleGLEventListener,
