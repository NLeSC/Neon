...
public class RealisticEarthGLEventListener extends ESightGLEventListener {
    ...
    private ShaderProgram shaderProgram_Earth, shaderProgram_Atmosphere, postprocessShader;
    ...
    private GeoSphere geoSphere, atmSphere;

    // Texture definitions for the spheres
    private Texture2D colorTex, bumpTex, specularTex, cityLightsTex, cloudTex, cloudTransparencyTex;
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        try {
            ...
            shaderProgram_Earth = loader.createProgram(gl, "texture", new File("shaders/vs_perFragmentLighting.vp"),
                    new File("shaders/fs_perFragmentLighting.fp"));
        ...
        bumpTex = new ImageTexture("images/earthbump1k.jpg", 0, 0, GL3.GL_TEXTURE3);
    ...
    private void renderGeoSphere(GL3 gl, MatF4 mv, ShaderProgram program) throws UninitializedException {
        ...
        program.setUniform("bumpTex", bumpTex.getMultitexNumber());
