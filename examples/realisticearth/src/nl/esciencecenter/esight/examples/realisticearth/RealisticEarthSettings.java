 ...
 * 
 */
public class RealisticEarthSettings extends Settings {
    private final static Logger logger = LoggerFactory.getLogger(RealisticEarthSettings.class);

    private static class SingletonHolder {
        public final static RealisticEarthSettings instance = new RealisticEarthSettings();
    }

    public static RealisticEarthSettings getInstance() {
    ...
    private RealisticEarthSettings() {
        super();
