 ...
 * 
 */
public class RealisticEarthExample {
    ...
    private static RealisticEarthInterfaceWindow examplePanel;
    ...
    private static RealisticEarthGLEventListener exampleGLEventListener;
    ...
    public static void main(String[] args) {
        new RealisticEarthExample();
    }

    public RealisticEarthExample() {
        // Create the Swing interface elements
        examplePanel = new RealisticEarthInterfaceWindow();

        // Create the custom GLEventListener
        exampleGLEventListener = new RealisticEarthGLEventListener();

        // Create the default ESight OpenGL window.
        new ESightNewtWindow(true, RealisticEarthInputHandler.getInstance(), exampleGLEventListener,
