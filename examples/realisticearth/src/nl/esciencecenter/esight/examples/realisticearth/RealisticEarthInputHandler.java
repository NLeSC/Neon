 ...
 * 
 */
public class RealisticEarthInputHandler extends InputHandler implements MouseListener, KeyListener {

    private static class SingletonHolder {
        public static final RealisticEarthInputHandler instance = new RealisticEarthInputHandler();
    }

    public static RealisticEarthInputHandler getInstance() {
