 ...
 * 
 */
public class GoggleSwingInputHandler extends InputHandler implements MouseListener, KeyListener {

    private static class SingletonHolder {
        public static final GoggleSwingInputHandler instance = new GoggleSwingInputHandler();
    }

    public static GoggleSwingInputHandler getInstance() {
