 ...
 * 
 */
public class GoggleSwingSettings extends Settings {
    private final static Logger logger = LoggerFactory.getLogger(GoggleSwingSettings.class);

    private static class SingletonHolder {
        public final static GoggleSwingSettings instance = new GoggleSwingSettings();
    }

    public static GoggleSwingSettings getInstance() {
        return SingletonHolder.instance;
    }

    private String screenshotFileName;

    private GoggleSwingSettings() {
        super();
