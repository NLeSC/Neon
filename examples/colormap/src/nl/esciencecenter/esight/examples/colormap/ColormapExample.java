...
public class ColormapExample {
    ...
    private static ColormapExampleInterfaceWindow examplePanel;
    ...
    private static ColormapExampleGLEventListener exampleGLEventListener;
    ...
    public ColormapExample() {
        // Create the Swing interface elements
        examplePanel = new ColormapExampleInterfaceWindow();

        // Create the custom GLEventListener
        exampleGLEventListener = new ColormapExampleGLEventListener();

        // Create the default ESight OpenGL window.
        new ESightNewtWindow(true, ColormapExampleInputHandler.getInstance(), exampleGLEventListener,
