...
/**
 * Geometry shader object representation. These shaders represent an optional
 * intermediate step of the rendering process, where every vertex is potentially
 * transformed into multiple vertices.
 * 
...
public class GeometryShader extends Shader {
     ...
     */
    public GeometryShader(String shaderName, File file) throws FileNotFoundException {
     ...
     *             If the file was absent.
     */
    public GeometryShader(String shaderName, String shaderCode) throws FileNotFoundException {
