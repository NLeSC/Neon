 ...
 * 
 */
public abstract class NeonGLEventListener implements GLEventListener {
    private static final Logger logger = LoggerFactory.getLogger(NeonGLEventListener.class);
     ...
     */
    public NeonGLEventListener(InputHandler inputHandler) {
        this.loader = new ShaderProgramLoader();
        this.font = FontFactory.get(fontSet).getDefault();
