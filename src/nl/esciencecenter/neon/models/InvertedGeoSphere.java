...
public class InvertedGeoSphere extends Model {
    ...
    private Float3Vector[] makeQuad(int latRib, int lonRib, float radius) {
        ...
        Float3Vector[] result = new Float3Vector[] { new Float3Vector(x00, y00, z00).mul(radius), new Float3Vector(x11, y11, z11).mul(radius),
                new Float3Vector(x01, y01, z01).mul(radius),
