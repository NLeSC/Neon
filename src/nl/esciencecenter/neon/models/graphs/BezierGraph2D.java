...
/**
 * Convenience class to create a 2D Bezier graph model.
 * 
...
public class BezierGraph2D {
    ...
    public BezierGraph2D(int horizontalSegments, Color4[] colors, String[] seperateColorNames,
        ...
        for (int i = 0; i < colors.length; i++) {
            segmentedLines.put(i, new BezierLine(horizontalSegments, DEFAULT_WIDTH / horizontalSegments, colors[i]));
        }
