...
public abstract class Texture2D extends Texture {
    ...
    public void init(GL3 gl) {
        if (!initialized) {
            ...
            // Wrap.
            gl.glTexParameteri(GL3.GL_TEXTURE_2D, GL3.GL_TEXTURE_WRAP_S, GL3.GL_CLAMP_TO_BORDER); // .GL_CLAMP_TO_EDGE);
            gl.glTexParameteri(GL3.GL_TEXTURE_2D, GL3.GL_TEXTURE_WRAP_T, GL3.GL_CLAMP_TO_BORDER); // .GL_CLAMP_TO_EDGE);
